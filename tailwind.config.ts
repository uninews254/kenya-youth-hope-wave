	...
	theme: {
		...
		extend: {
			...
			keyframes: {
				...
				'pulse-hope': {
					'0%, 100%': { boxShadow: '0 0 0 0 hsl(var(--hope-green) / 0.7)' },
					'50%': { boxShadow: '0 0 0 10px hsl(var(--hope-green) / 0)' }
				},
				'wave': {
			...
			animation: {
				...
				'pulse-hope': 'pulse-hope 2s cubic-bezier(0.4, 0, 0.6, 1) infinite',
